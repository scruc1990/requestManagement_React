...
export default function EmployeeForm(ref, func) {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      <InputComponent id="id" type="number" name="id" label="Identificación" formik={formik} />
      <InputComponent id="nombre" type="text" name="nombre" label="Nombre" formik={formik} />
      <InputComponent
        id="fecha_ingreso"
        type="date"
        name="fecha_ingreso"
        ...
        formik={formik}
      />
      <InputComponent id="salario" type="number" name="salario" label="Salario" formik={formik} />
