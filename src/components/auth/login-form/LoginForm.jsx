...
const LoginForm = () => {
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="flex flex-col items-center">
      <InputComponent id="usuario" name="usuario" label="Usuario" type="text" formik={formik} />
      <InputComponent
        id="contraseña"
        name="contraseña"
        label="Contraseña"
        ...
        formik={formik}
      />
      <button type="submit" className="rounded bg-blue-500 text-white px-4 py-2 mt-4">
        Iniciar sesión
      </button>
    </form>
  );
